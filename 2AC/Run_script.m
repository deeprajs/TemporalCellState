Ymax=[0.794,0.879,0.807];
EC50=[0.028,0.112,0.009];
N=[0.682,0.584,2.776];
...
Counts_theo_AP=Combinationdata{1,1}/Combinationdata{1,1}(8,1);
d=figure; 
subplot(3,2,1);
hm=heatmap(Counts_theo_AP);
caxis([0 1])
hm.Colormap=hot;
Ax = gca;
...
A=xlsread('E:\U87\220529_181944_deepraj_abem_PD_U87_5ul_1\MyExpt_Image.csv');
B=xlsread('E:\U87\220529_181944_deepraj_abem_PD_U87_5ul_2\MyExpt_Image.csv');
C=xlsread('E:\U87\220529_181944_deepraj_abem_PD_U87_5ul_3\MyExpt_Image.csv');
...
% %% Abem-Tak
Counts_theo_AT=Combinationdata{1,2}/Combinationdata{1,2}(8,1);
% d=figure; 
subplot(3,2,3);
hm=heatmap(Counts_theo_AT);
caxis([0 1])
hm.Colormap=hot;
Ax = gca;
Ax.XDisplayLabels = nan(size(Ax.XDisplayData));
...
% %% Abem TAK exp
A=xlsread('E:\U87\220128_195214_deepraj_abem_TAK_bio1\MyExpt_Image.csv');
B=xlsread('E:\U87\220128_195214_deepraj_abem_TAK_bio2\MyExpt_Image.csv');
C=xlsread('E:\U87\220128_195214_deepraj_abem_TAK_bio3\MyExpt_Image.csv');
...
% %% PD-Tak
Counts_theo_PT=Combinationdata{1,3}/Combinationdata{1,3}(8,1);
% d=figure; 
subplot(3,2,5);
hm=heatmap(Counts_theo_PT);
caxis([0 1])
hm.Colormap=hot;
Ax = gca;
Ax.XDisplayLabels = nan(size(Ax.XDisplayData));
...
% %% PD-tak exp
A=xlsread('E:\U87\220202_210334_deepraj_PD_TAK_bio1\MyExpt_Image.csv');
B=xlsread('E:\U87\220202_210334_deepraj_PD_TAK_bio2\MyExpt_Image.csv');
C=xlsread('E:\U87\220202_210334_deepraj_PD_TAK_bio3\MyExpt_Image.csv');
...
Counts_tot=Counts_1_mat_PT+Counts_2_mat_PT+Counts_3_mat_PT;
% GC=Counts_tot-37.5*3*5;
...
save('theocounts.mat','Counts_theo_AP','Counts_theo_AT','Counts_theo_PT');
...
print('4C.tiff','-dtiff',['-r' num2str(100)]);