function Cell_response=Markovtransition_total (params,steps,y0,D,Mo)
...
MD=zeros(1,3);
% MD(1)=0.2*D/(D+params(7));
% MD(1)=(D^params(8))/((D^params(8))+(params(7)^params(8)));
...
MP2(1)=Mo(1)*(1+0.6*(1-(MP2(2)/Mo(2))));
MD=zeros(1,3);
% MD(2)=0.2*D/(D+params(8));
% MD(2)=(D^params(10))/((D^params(10))+(params(9)^params(10)));
...
MD=zeros(1,3);
% MD(3)=D/(D+params(9));
% MD(3)=(D^params(12))/((D^params(12))+(params(11)^params(12)));
